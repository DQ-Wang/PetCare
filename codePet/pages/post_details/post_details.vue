<template>
  <div class="pet-container">
    ...
    <div class="post-item">
      <div class="user-info">
        <!-- 使用数据库中的images作为用户头像 -->
        <img :src="post.images && post.images[0] ? post.images[0] : user.avatar" alt="用户头像" class="avatar">
    ...
    <div class="comment-page">
      <div class="comment-list">
        <div class="comment-item">
          <img src="../../static/汪汪喵切图/帖子详情页/圆形 5@3x.png" alt="头像" class="avatar">
          <div class="comment-content">
            ...
            <div class="comment-meta">
              ...
              <div class="like-area">
                <img src="../../static/汪汪喵切图/帖子详情页/like.png" alt="点赞" class="like-icon">
        ...
        <div class="sub-comment-item">
          <img src="../../static/汪汪喵切图/帖子详情页/圆形 5@3x.png" alt="子评论头像" class="sub-avatar">
          <div class="sub-comment-content">
            ...
            <div class="sub-comment-meta">
              ...
              <div class="sub-like-area">
                <img src="../../static/汪汪喵切图/帖子详情页/like.png" alt="子评论点赞" class="sub-like-icon">
              </div>
            </div>
          </div>
        </div>
...
<script setup>
  ...
  onLoad(async (options) => {
    ...
    if (postId) {
      ...
      console.log('获取的帖子详情:', res.result);
      if (res.result && res.result.data.length > 0) {
        postDetail.value = res.result.data[0]
      }
    }
  })
