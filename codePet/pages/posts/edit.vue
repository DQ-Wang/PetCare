  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      ...
      <uni-forms-item name="header" label="标题" required>
        <uni-easyinput placeholder="帖子的标题" v-model="formData.header"></uni-easyinput>
      </uni-forms-item>
      ...
      <uni-forms-item name="category_id" label="标签">
        <uni-data-checkbox :multiple="true" v-model="formData.category_id"></uni-data-checkbox>
      </uni-forms-item>
      <uni-forms-item name="location" label="地理位置">
        <undefined v-model="formData.location"></undefined>
      </uni-forms-item>
...
<script>
  import { validator } from '../../js_sdk/validator/posts.js';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("images,header,content,category_id,location").get().then((res) => {
