  ...
  <view class="pet-container">
    ...
    <view class="waterfall-container">
      ...
      <view class="waterfall-column">
        <view v-for="item in leftColumn" :key="item._id" class="card" :data-id="item._id" @click="goDetail(item._id)">
          <!-- 图片容器（保持比例） -->
          ...
          <view class="card-info">
            ...
            <view class="stats">
              ...
              <text class="like" :class="{ liked: item.liked }" @click.stop="toggleLike(item)">
                ♥ {{ item.like_count }}
              </text>
            </view>
          </view>
      ...
      <!-- 右列 -->
      <view class="waterfall-column">
        <view v-for="item in rightColumn" :key="item._id" class="card" :data-id="item._id" @click="goDetail(item._id)">
          <!-- 图片容器（保持比例） -->
          <view class="image-container" :style="{ paddingTop: getImageAspectRatio(item) }">
            <image v-if="item.images && item.images.length" class="card-image" :src="item.imageTempUrl"
